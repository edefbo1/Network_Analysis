...
\begin{itemize}[leftmargin=*]
  ...
  \item \textbf{Limiti interpretativi dell'approccio strutturale}: L'analisi quantitativa identifica pattern di connessione, ma non ne svela le motivazioni profonde o il valore artistico. Ad esempio, possiamo misurare che un artista collega due comunità musicali, ma non sappiamo se si tratti di una scelta creativa consapevole, di una relazione personale, di una strategia commerciale. Senza integrare i dati strutturali con fonti qualitative, come interviste, analisi dei testi, ricostruzione dei contesti produttivi o dinamiche di mercato, le conclusioni sulle “strategie collaborative” o sul “ruolo sociale” degli artisti restano ipotesi plausibili ma non verificate.
\end{itemize}
