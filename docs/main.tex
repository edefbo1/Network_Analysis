...
\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{images/eigenvectorW.pdf}
...
to collaborate within the same or closely related macro-genres.\vspace{3pt}
\end{minipage}
\hfill
\begin{minipage}[t]{0.43\textwidth}
  \centering
  \vspace{0pt}% Assicura allineamento top consistente
  \includegraphics[width=\linewidth]{images/louvain.pdf}
  \captionof{figure}{Community structure obtained by applying the Louvain algorithm in Gephi.}
  \label{fig:louvain}
\end{minipage}
