...
The results show a highly asymmetric distribution: while the average degree
centrality is 0.0031, the maximum value reaches 0.0689, indicating that most
artists have relatively few collaborations, whereas a small number of nodes act
as highly connected hubs.
